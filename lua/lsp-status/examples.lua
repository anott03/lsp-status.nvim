...
local status_errors = require('lsp-status').status_errors
local status_warnings = require('lsp-status').status_warnings
local status_hints = require('lsp-status').status_hints
local status_info = require('lsp-status').status_info

M._init = function(_, _config)
  config = vim.tbl_extend('force', config, _config)
end

M.statusline_lsp = function(bufnr)
  local errros = status_errors()
  local warnings = status_warnings()
  local hints = status_hints()
